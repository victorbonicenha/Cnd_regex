...
Este repositório contém automação para processos internos e manipulação de dados potencialmente sensíveis. Antes de distribuir, publicar ou executar em produção, valide regras de compliance, LGPD, termos de uso dos portais acessados e políticas internas da organização.
